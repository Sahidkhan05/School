...
export default function SelectExamPage() {
  ...
  // Form State (Create + Edit combined)
            ...
            {examList.map((exam) => (
              <div
                ...
                className={`flex justify-between items-center border p-4 rounded-lg cursor-pointer transition-all ${
                  selectedExam?.id === exam.id ? "border-blue-500 bg-blue-50" : "border-gray-300 hover:border-blue-300"
                }`}
                    ...
                    examList.map((ex) => (
                      ...
                      >
                        ...
                        <div className="flex gap-2">
                          ...
                          <button
                            onClick={() => ex.id !== undefined && handleDeleteExam(ex.id)}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div>
                        ...
                        <select
                         ...
                         onChange={(e) =>
  setFormExam({ ...formExam, exam_type: e.target.value as Exam["exam_type"] })
}
